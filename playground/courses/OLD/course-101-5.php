...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    function drawVisualization() {
      ...
      var query = new google.visualization.Query('https://docs.google.com/spreadsheet/ccc?key=0Ajf0Qu3iKU02dHdsa0c4QkNEaXFTUjFiN1l0ZEhiNkE#gid=0');
  ...
  <body style="font-family: Arial;border: 0 none; text-align:center;">
    <div id="visualization" style="height: 500px; width: 800px;margin:auto;"></div><br />
<br />
